...
def wykrywanie_anomalii(logs):
    ...
    # Nietypowe IP - uproszczona detekcja: IP spoza typowych sieci prywatnych 10.x.x.x, 192.168.x.x, 172.16-31.x.x
    ...
    # Nietypowe urządzenia - jeśli urządzenie występuje rzadko (np. mniej niż 1% wszystkich)
    ...
    # Nagłe skoki aktywności: prosty detektor - dni z akcjami > średnia + 2*std dev
    dzienne_aktyw = defaultdict(int)
    for row in logs:
